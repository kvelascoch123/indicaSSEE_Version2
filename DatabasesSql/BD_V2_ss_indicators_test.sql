...
-- ----------------------------
INSERT INTO `al_indicators` VALUES ('1', '100', 'Y', 'liquidez', '2019-09-02 16:47:30', '100', '2019-09-02 16:47:37', '100', 'liquidez corriente', '1', '1', 'Y', 'Y', '1', 'B', 'N', null, null, null, 'No tengo interpretacion para este indicador.', null, '0', '6', '0', '5', '6', '3', '5', '6');
...
-- ----------------------------
INSERT INTO `al_indicators_years` VALUES ('1', '100', 'Y', 'liquidez', '2019-09-02 16:47:30', '100', '2019-09-02 16:47:37', '100', 'liquidez corriente', '1', '1', '1.37', '1.46', '6.16', '1.56', '1.43', '-8.33', '1', '2019', 'agosto', 'B');
...
-- ----------------------------
-- Table structure for `al_token_user`
-- ----------------------------
DROP TABLE IF EXISTS `al_token_user`;
CREATE TABLE `al_token_user` (
  `al_token_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `al_user_id` int(11) NOT NULL,
  `consumido` tinyint(1) NOT NULL,
  `token` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nombre_indicador` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `anio` varchar(4) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mes` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`al_token_id`)
) ENGINE=MyISAM AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of al_token_user
-- ----------------------------
INSERT INTO `al_token_user` VALUES ('38', '1', '0', 'fTUsnJgJgOBx+UcV9um73t2ImqqOLctq4HT7Eh+0Z0Q0rhTHzlmxdsjXMGNj8PNV574UFBfZ0Z5woBTWA8G6ulvDmC9OhwmxvhvOQuUUxCmA9RYOCeiRScnpKB4agATj', 'liquidez corriente', '2019', 'enero', '2019-09-25 17:29:33', '2019-09-25 17:29:33');
INSERT INTO `al_token_user` VALUES ('39', '2', '1', '20GaViWSPxsfYteAHN4r+5+eQjD/quj4AUG8qJodtidCL/EBAGP8kIT5TwF8itqxls+nnMxIAdEUW4o8/dnc67qit7ltxkBLVmRzdO+mC31sAuSfGKR5yJicdkfTANqQ', 'liquidez corriente', '2019', 'undefined', '2019-09-25 17:31:12', '2019-09-25 17:31:12');
...
-- Records of al_user
-- ----------------------------
INSERT INTO `al_user` VALUES ('1', '100.00', 'Y', 'Ninguna', '2019-09-02 15:55:04', '100', '2019-09-02 15:55:52', '100', 'Franklin', 'franklinalvarez88888@gmail.com', 'al47', '1', 'franklin');
INSERT INTO `al_user` VALUES ('2', '100.00', 'Y', 'Ninguna', '2019-09-02 16:14:34', '100', '2019-09-02 16:14:38', '100', 'Kevin', 'kav.chuga@yavirac.edu.ec', 'abcd', '2', 'kevin');
...
INSERT INTO `al_user` VALUES ('5', '100.00', 'Y', 'Ninguna', '2019-09-17 12:14:10', '100', '2019-09-17 12:14:28', '100', 'Darwin', 'dquintana2003@gmail.com', 'quintana', '1', 'darwin');
...
INSERT INTO `migrations` VALUES ('6', '2019_09_23_170413_al_token_user', '1');
...
CREATE TABLE `ss_configuration` (
  ...
  `url_api` varchar(300) DEFAULT NULL,
  `url_project` varchar(300) DEFAULT NULL,
  `url_endpoint` varchar(300) DEFAULT NULL,
  `mail` varchar(300) DEFAULT NULL,
  `smt_port` decimal(6,0) DEFAULT NULL,
  `token_p1` varchar(300) DEFAULT NULL,
  `token_p2` varchar(300) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `ss_configuration` VALUES ('1', '100.00', 'y', 'configuracion de Sidesoft', '2019-09-02 16:18:13', '100', '2019-09-02 16:18:27', '100', 'Sidesoft', '1', 'http://www.sidesoft.com.ec', 'app_indicadores', 'api/alexa', '2', '3380', '0123456789abcdef0123456789abcdef', 'abcdef9876543210abcdef9876543210');
